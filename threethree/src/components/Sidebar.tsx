  ...
  return (
    <div className="w-80 bg-white border-r border-gray-300 shadow-lg flex flex-col h-full">
      <div className="p-6 border-b border-gray-300 bg-gray-50">
        <h1 className="text-2xl font-bold text-gray-900">Store Layout Designer</h1>
        <p className="text-sm text-gray-700 mt-2 font-medium">Design your 2D store layout</p>
      </div>
